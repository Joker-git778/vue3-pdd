            ...
            <section>
              ...
              <section class="login_verification">
                ...
                <div class="switch_show">
                  <img @click.prevent="dealPwdMode(false)" :class="{on: pwdMode}" src="./images/hide.png" alt=""
                       width="20">
                  <img @click.prevent="dealPwdMode(true)" :class="{on: !pwdMode}" src="./images/show.png" alt=""
                       width="20">
                </div>
              </section>
              <section class="login_message">
